...
class MultiLabelLossImagiNet(nn.Module):
    def __init__(self, temp_1=0.07, temp_base_1=0.07, temp_2=0.07, temp_base_2=0.07, temp_3=0.07, temp_base_3=0.07, weight_1=1, weight_2=1, weight_3=1):
        super(MultiLabelLossImagiNet, self).__init__()
